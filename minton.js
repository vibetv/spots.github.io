// Script JavaScript untuk filter dan sort tabel
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (savedDate) document.getElementById('filter-date').value = savedDate;
        if (savedTeam) document.getElementById('filter-team').value = savedTeam;
        filterMatches();
    ...
    function filterMatches() {
        ...
        noMatches.style.display = matchFound ? "none" : "block";
    }
